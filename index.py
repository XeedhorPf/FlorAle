...
write("Para la niña más bonita", align="center", font=("Arial", 11, "normal")) # Cambia el fuente y tamaño del texto
# penup()
# goto(0, 330)
# pendown()
...
goto(0, -300)
pendown()
write("Mi Jandii <3", align="center", font=("Arial", 11, "normal"))
hideturtle()
